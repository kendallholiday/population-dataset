...
for ($year = 2013; $year -le 2019; $year++) {
    $table.Columns.Add("$year", [string])
}
$table.Columns.Add("2019 Factors", [string])
$table.Columns.Add("2020", [string])
...
$table | Export-Csv -Path "C:\Users\$env:UserName\Downloads\population_data_report.csv" -NoTypeInformation
